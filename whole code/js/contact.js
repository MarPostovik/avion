...
let pagelinks = document.querySelector('.page-links');
...
let SuccessfulContactFormModal = document.getElementById('successful-contact-form');
let CloseSuccessfulContactFormModal = document.getElementById('close-successful-contact-form');

ContactForm.addEventListener('submit', function(e) {
  e.preventDefault();
  clearFormFields('.contacts__input');
  clearFormFields('.contacts__textarea');
  setTimeout(function() {
    SuccessfulContactFormModal.style.display = 'flex';
    SuccessfulContactFormModal.querySelector('.search-modal__container').classList.add('animate__animated');
    SuccessfulContactFormModal.querySelector('.search-modal__container').classList.add('animate__backInDown');
  }, 500);
});

CloseSuccessfulContactFormModal.addEventListener('click', () => {
  SuccessfulContactFormModal.style.display = 'none';
});
