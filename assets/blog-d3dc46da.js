import"./animate-2a595e35.js";let t=document.getElementById("gamburger-menu-icon"),l=document.querySelector(".bottom-line-nav"),e=document.querySelector("nav");t.addEventListener("click",()=>{l.style.display==="flex"?(l.style.display="none",e.classList.add("animate__fadeOutLeft"),setTimeout(()=>{e.classList.remove("active"),e.classList.remove("animate__fadeOutLeft")},500),e.classList.remove("animate__fadeInLeft"),t.innerHTML=`<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                        ...
                        </svg>`):(l.style.display="flex",e.classList.add("active"),e.classList.add("animate__fadeInLeft"),t.innerHTML='<ion-icon name="close-outline" class="close-nav"></ion-icon>')});let n=document.getElementById("close-pop-up__btn"),i=document.querySelector(".pop-up");n.addEventListener("click",()=>{i.style.display="none"});
